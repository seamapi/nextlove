...
export function mapMethodsToFernSdkMetadata(methods: RouteSpec['methods'], path: string) {
  ...
  if (!atLeastOneMethodIsPost) {
    throw new Error("A route that accepts multiple methods should include at least the POST method.");
  }
